-- Eastern calendar for legacy `buy_shop_item` (four hard-coded SKUs from migration 036).
-- If your project uses a catalog-driven `buy_shop_item` (shop_items), merge the same
-- `America/New_York` date logic into that function instead of applying this wholesale.
