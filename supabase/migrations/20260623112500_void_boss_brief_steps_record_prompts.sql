-- Void Navigators Boss fight · Student proposed: quest brief, checklist steps, Panel iii prompts.
...
The 4×8 CNC is available if the project calls for it. Any guild's tools are available if the project calls for them. The only constraint is that the made thing has to be worth making for the person you named.

By now you've cut shapes, made joints, translated 3D data, restored things that belonged somewhere. You know what this machine can do. The only thing standing between you and this tile is deciding what's actually worth making — and having the nerve to say it out loud.$desc$,
  steps = $steps$[
    ...
    {"description": "If approved: plan your build. What tools, what materials, what order of operations.", "requiresApproval": false},
