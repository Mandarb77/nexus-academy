    ...
    <div className="app-shell bench-chrome">
      ...
      <main className="page">
        <header className="page-header bench-page-title-row">
          <h1 className="page-title bench-page-title">Dispatch</h1>
        ...
        <div className="stack">
          {SECTIONS.map((s) => {
            ...
            <section key={s.title} id={sectionId} className="card powerups-section" aria-label={s.title}>
              ...
              {s.body.map((p) => (
                <p key={p} className="muted bench-card-lead">
                  {p}
                </p>
              ))}
              {s.title === 'Maine History' ? (
                <div
                  className="card bench-note-card bench-note-card--alert"
                  role="note"
                  aria-label="Important note about consultation"
                >
                  <strong className="bench-inset-card__title">Important</strong>
          ...
          <section id="backstory" className="card powerups-section" aria-label="The Backstory dossier">
            <h2 className="bench-card-heading">The Backstory</h2>
            <p className="muted bench-card-lead">
              Case file: Louise Green — Maine Wesleyan Seminary and Female College, Kents Hill.
            </p>

            <div
              className="card bench-dossier"
              role="region"
            ...
            >
              ...
              <hr className="bench-dossier__rule" />

              <p className="bench-dossier__heading">NARRATIVE</p>
              ...
              <p className="bench-dossier__quote">Find what I found.</p>
              <p>
